...
function selectCaseQ1E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ1E1(idUsuario)
...
function selectCaseQ1E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ1E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ2E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ2E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ2E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ2E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ3E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ3E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ3E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ3E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ4E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ4E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ4E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ4E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ5E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ5E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ5E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ5E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ6E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ6E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ6E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ6E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ7E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ7E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ7E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ7E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ8E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ8E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ8E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ8E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ9E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ9E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ9E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ9E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ10E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ10E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ10E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ10E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ11E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ11E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ11E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ11E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ12E1(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ12E1(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
...
function selectCaseQ12E2(req, res) {
    var idUsuario = req.params.idUsuario
    votosModel.selectCaseQ12E2(idUsuario)
    .then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
