...
router.get("/selectCaseQ1E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ1E1(req, res);
});
...
router.get("/selectCaseQ1E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ1E2(req, res);
});
...
router.get("/selectCaseQ2E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ2E1(req, res);
});
...
router.get("/selectCaseQ2E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ2E2(req, res);
});
...
router.get("/selectCaseQ3E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ3E1(req, res);
});
...
router.get("/selectCaseQ3E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ3E2(req, res);
});
...
router.get("/selectCaseQ4E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ4E1(req, res);
});
...
router.get("/selectCaseQ4E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ4E2(req, res);
});
...
router.get("/selectCaseQ5E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ5E1(req, res);
});
...
router.get("/selectCaseQ5E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ5E2(req, res);
});
...
router.get("/selectCaseQ6E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ6E1(req, res);
});
...
router.get("/selectCaseQ6E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ6E2(req, res);
});
...
router.get("/selectCaseQ7E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ7E1(req, res);
});
...
router.get("/selectCaseQ7E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ7E2(req, res);
});
...
router.get("/selectCaseQ8E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ8E1(req, res);
});
...
router.get("/selectCaseQ8E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ8E2(req, res);
});
...
router.get("/selectCaseQ9E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ9E1(req, res);
});
...
router.get("/selectCaseQ9E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ9E2(req, res);
});
...
router.get("/selectCaseQ10E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ10E1(req, res);
});
...
router.get("/selectCaseQ10E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ10E2(req, res);
});
...
router.get("/selectCaseQ11E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ11E1(req, res);
});
...
router.get("/selectCaseQ11E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ11E2(req, res);
});
...
router.get("/selectCaseQ12E1/:idUsuario", function (req, res) {
    votosController.selectCaseQ12E1(req, res);
});
...
router.get("/selectCaseQ12E2/:idUsuario", function (req, res) {
    votosController.selectCaseQ12E2(req, res);
});
